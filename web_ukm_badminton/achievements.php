...
<head>
    ...
    <link rel="stylesheet" href="css/css_achievement/style.css">
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="201ple-navbar-collapse-1">
    ...
    <table width="90%" align="center">
        ...
        <tr>
        <th>No</th><th>Nama Kejuaraan</th><th>Peringkat</th><th>Tahun</th><th>Peraih</th>
        </tr>

        <?php
        $hasil_query = mysqli_query($link, "select * from achievements");
        //get row
        ...
        <tr>
        <td><?php echo $nomor; ?></td><td><?php echo $nama_kejuaraan; ?></td><td><?php echo $peringkat; ?></td><td><?php echo $tahun; ?></td><td><?php echo $peraih; ?></td>
        </tr>
